...
const SUMMARY_CARDS = [
  { icon: BarChart3, label: "Resume Score", value: "92%" },
  { icon: CheckCircle2, label: "Matched Skills", value: "12" },
  { icon: XCircle, label: "Missing Skills", value: "4" },
  { icon: ShieldCheck, label: "ATS Friendly", value: "Yes" },
];
...
const MISSING_SKILLS = ["React", "Node.js", "AWS", "Docker", "SQL", "Python"];

const AI_SUGGESTIONS = [
  "Improve your professional summary by highlighting measurable achievements.",
  "Use stronger action verbs.",
  "Tailor keywords according to the target role.",
    ...
    <main className="bg-white">
      ...
      <section className="mx-auto max-w-3xl px-4 pb-20 sm:px-6">
        ...
        >
          ...
          <span className="mt-6 inline-flex items-center gap-2 rounded-full bg-green-50 px-4 py-1.5 text-sm font-semibold text-green-600">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <motion.div
            ...
            className="flex h-full flex-col rounded-2xl border border-gray-100 bg-white p-8 shadow-sm shadow-gray-100/80"
          >
            ...
            <ul className="mt-5 space-y-3">
              {IMPROVEMENTS.map((improvement) => (
                <li
                  ...
                  className="flex items-start gap-3 text-sm leading-relaxed text-gray-600"
                >
                  <Circle className="mt-1.5 h-2 w-2 shrink-0 fill-red-600 text-red-600" />
                  {improvement}
                </li>
              ))}
            </ul>
